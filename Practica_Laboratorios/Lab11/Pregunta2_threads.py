...
if __name__ == "__main__":
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=len(rutas_posibles)) as executor:
        resultados = list(executor.map(Tiempo_ruta, rutas_posibles))
